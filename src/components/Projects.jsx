...
const projects = [
  ...
  },
  {
    ...
    image: "/images/cpu_scheduler.png"
  }
];
              ...
              <div className="md:w-1/2 relative group rounded-lg overflow-hidden border border-neon-green/30 bg-dark-surface min-h-[250px] flex items-center justify-center">
                {project.image ? (
                  <img 
                    src={project.image} 
                    alt={project.title} 
                    className="w-full h-full object-contain p-2 opacity-80 group-hover:opacity-100 transition-opacity duration-500"
                  />
                ) : (
                ...
                <div className="absolute top-0 left-0 w-full h-[2px] bg-neon-green/50 opacity-0 group-hover:opacity-100 group-hover:animate-scanline z-20 pointer-events-none"></div>
              </div>
